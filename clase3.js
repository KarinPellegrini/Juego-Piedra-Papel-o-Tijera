...
while (puntajes.usuario < 2 && puntajes.computadora < 2) {
    ...
    if (resultadoDePartida.includes("ganaste")) {
        puntajes.usuario++;
    } else if (resultadoDePartida === 'Una lástima, perdiste.') {
...
// AVISA AL USUARIO EL RESULTADO
if(puntajes.usuario>puntajes.computadora){
    alert("Felicidades! Sos el ganador!")
}
else{
...
console.log("Jugaste " + cantidadPartidas + " partidas");
